...
export default function Topbar({ onAdd, addLabel = '+ Ajouter', onHamburger }) {
  ...
  return (
    <div className="topbar">
      <div className="topbar-left" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        {/* ── Hamburger (mobile uniquement via CSS) ── */}
        ...
        <div>
          ...
          <div className="breadcrumb">AgriCoop / <span>{meta.bc}</span></div>
        </div>
      </div>
      ...
      <div className="topbar-right">
        <div
          className="notif-btn"
          onClick={() => toast('⚠️ Vérifiez les alertes de stock')}
          title="Notifications"
        >
